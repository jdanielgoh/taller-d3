...
function visualizacionPaths() {
  ...
  var svg = d3.select("#figuras-1").append("svg").attr("width", ancho + margin.left + margin.right).attr("height", alto + margin.top + margin.bottom).append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")"); //Formato de tiempo
  ...
  d3.csv("../../hopkinsDefunciones_paravis2.csv").then(function (data) {
    ...
    console.log(data); //Creo diccionario de colores aleatorios
    ...
    var color = d3.scaleOrdinal().domain(keys).range(Object.values(dict_cats)); ///https://observablehq.com/@d3/streamgraph-transitions
    //Apilando la data

    var stackedData = d3.stack().offset(d3.stackOffsetNone).keys(keys)(data);
    console.log(stackedData); //Esta es la función que va a crear los paths
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/figuras/figuras-1.js"], null)
//# sourceMappingURL=/figuras-1.88689cd7.js.map